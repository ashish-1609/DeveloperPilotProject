...
class RatingControllerTest {
    ...
    public void saveRating_InvalidRating(){
        ...
        assertEquals(List.of("Hotel can be rated only in range of 0-10.").toString(), ((ApiResponse) responseEntity.getBody()).getMessage());
    }
    ...
    void deleteRating() {
        ...
        assertEquals(HttpStatus.OK, responseEntity.getStatusCode());
        assertEquals("Rating Deleted Successfully", ((ApiResponse) responseEntity.getBody()).getMessage());
    }
    ...
    void deleteRatingByUserId() {
        ...
        assertEquals("Ratings Deleted Successfully", ((ApiResponse) apiResponseResponseEntity.getBody()).getMessage());
    }
    ...
    void deleteAllRatings() {
        ...
        assertEquals(HttpStatus.OK, apiResponseResponseEntity.getStatusCode());
        assertEquals("All Ratings Deleted Successfully", ((ApiResponse) apiResponseResponseEntity.getBody()).getMessage());
    }
}